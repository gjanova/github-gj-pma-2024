    ...
    Scaffold(
        ...
        Column(
            ...
            OutlinedTextField(
                ...
                onValueChange = {
                    // Omezíme vstup na číslice a kontrolujeme, že číslo není větší než 150
                    if (it.all { char -> char.isDigit() } && it.toIntOrNull()?.let { it <= 99999 } == true) {
                        psc = it
                    }
                },
                label = { Text("PSČ") },
            ...
            Row(
                ...
                Button(
                    onClick = {
                        resultText = "Jmenuji se $name $surname. Je mi $age let a moje bydliště je $place, stát $state, PSČ $psc ."
                    },
